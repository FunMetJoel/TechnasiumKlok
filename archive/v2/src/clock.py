...
class Clock:
    def __init__(self, led_count:int, led_pin):
        ...
        self.brightness:float = 0.1

    def show(self):
        reversedPixels = self.pixels
        reversedPixels.reverse()
        for i, color in enumerate(reversedPixels):
